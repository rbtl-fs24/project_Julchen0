...
subtitle: "Food Waste at ETH Mensae"
author:
...
This project investigated the attitudes of students towards food waste reduction strategies at ETH mensae and how these would influence their behaviour. This project is oriented specifically towards ETH mensae, since UZH has a different caterer in their mensae, thus their food waste reduction strategies differ from ETH mensae.

Although it has been shown that most of the food waste in switzerland is generated from private housholds (@beretta2013quantifying), the food waste behaviour of the mensae is still interesting to investigate, since a lot of students eat the food from the mensa instead of preparing it in their private houshold.
...
If, however, we look at how much the participants of the survey know about the food waste reduction strategies of ETH mensae, as visible in @tbl-knowledge-mean, we notice that there is a lot of room for improvement for ETH to educate about how they try to limit their food waste. Participants were asked to rate their knwoledge on a scale from one to five, one meaning 'I have no idea' and five meaning 'I am an expert'.
...
Larger portion sizes are often handeled differently, depending on the mensae. At Polymensa, you could aks for a larger size but you could also get a free refill if you were still hungry after finishing the meal. In my opition, this made sense since in this case, less customers would prejudicely ask for a larger portion but in the end not finish it. If we look at @fig-habits, we see that some participants regularily ask for larger portion sizes, but there is generally hardly any leftover food.
...
When we look at the willingness to pay for a larger portion though, less than 50% of participants would be willing to pay for a larger sized portion, and they all would pay no more than a 1-2CHF price increase. Thus it makes sence that ETH changed their price policy at the Archimedes mensa, where they used to charge 3CHF for a larger sized portion.
...
-   Paricipants have limited knowledge about ETH's food waste reduction strategies
